...
Flasher ledAvantGauche, ledAvantDroite;
Flasher ledCapteurGauche, ledCapteurCentre, ledCapteurDroite;
Flasher ledArriereGauche, ledArriereDroite;

CUsSensor usGauche, usCentre, usDroite;

CIrSensor irGauche, irCentre, irDroite;
...
void loop(){
    ledAvantGauche.update();
    ledAvantDroite.update();
    ledArriereGauche.update();
    ledArriereDroite.update();
    
    ledCapteurGauche.update();
    ledCapteurCentre.update();
    ledCapteurDroite.update();
