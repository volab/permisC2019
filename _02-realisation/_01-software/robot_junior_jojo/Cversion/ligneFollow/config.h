...
#define BUZZER_PIN 4
    ...
    #define LINESENSOR_GAUCHE_EXTERNE_PIN 52
    #define LINESENSOR_GAUCHE_MILIEUX_PIN 50
    #define LINESENSOR_GAUCHE_INTERNE_PIN 48
    
    #define LINESENSOR_DROITE_EXTERNE_PIN 53
    #define LINESENSOR_DROITE_MILIEUX_PIN 51
    #define LINESENSOR_DROITE_INTERNE_PIN 49
